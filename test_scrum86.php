...
try {
    ...
    $service->sendToUser(
        $parent->id,
        'bus_boarding_morning', // نوع الإشعار: صعود باص الصباح (SCRUM-86)
        'طالبك ركب باص المدرسة (صباحاً)',
        'لقد ركب الطالب الحافلة الآن متوجهاً إلى المدرسة بسلام. (رسالة اختبار)',
        [
            'student_id' => 999, 
            'bus_id' => 999, 
    ...
    echo "✅ Morning Boarding Notification (SCRUM-86) sent successfully to '" . $parent->name . "' (National ID: " . $parent->national_id . ")!\n";
    echo "🔔 Check your Flutter app NOW!\n";
    echo "👀 You should see the blue 'Check-In' icon.\n";
} catch (\Exception $e) {
