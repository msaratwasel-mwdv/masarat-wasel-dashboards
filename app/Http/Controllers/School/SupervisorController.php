...
class SupervisorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::rollBack();
            return redirect()->back()->withErrors(['error' => 'An error occurred while creating the supervisor.']);
        }
    }
    ...
    public function update(Request $request, User $supervisor)
    {
        ...
        try {
            ...
            // return with inertia handles redirect implicitly when visiting via Inertia form
            return redirect()
