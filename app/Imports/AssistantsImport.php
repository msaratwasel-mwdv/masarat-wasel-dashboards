...
// app/Imports/AssistantsImport.php
...
class AssistantsImport implements SkipsEmptyRows, SkipsOnError, SkipsOnFailure, ToModel, WithBatchInserts, WithChunkReading, WithStartRow, WithUpserts, WithValidation
{
    ...
    public function rules(): array
    {
        return [
            ...
            '9' => 'nullable|string|max:20',  // Emergency Contact Phone
    ...
    public function customValidationAttributes(): array
    {
        return [
            ...
            '7' => 'العنوان / Address',
            '8' => 'اسم جهة الطوارئ / Emergency Contact Name',
            '9' => 'رقم الطوارئ / Emergency Contact Phone',
    ...
    public function model(array $row)
    {
        $data = [
            ...
            'email' => trim($row[6] ?? ''),
            'address' => trim($row[7] ?? ''),
            'emergency_contact_name' => trim($row[8] ?? ''),
            'emergency_contact_phone' => trim($row[9] ?? ''),
