...
class TeachersImport implements SkipsEmptyRows, SkipsOnError, SkipsOnFailure, ToModel, WithBatchInserts, WithChunkReading, WithStartRow, WithUpserts, WithValidation
{
    ...
    public function model(array $row)
    {
        ...
        if (empty($d['national_id']) || (empty($d['first_name_ar']) && empty($d['first_name_en']))) {
            return null;
        }
        ...
        $user->teacher()->updateOrCreate(['user_id' => $user->id], $teacherData);
