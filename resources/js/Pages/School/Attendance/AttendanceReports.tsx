...
export default function AttendanceReports() {
    ...
    return (
        ...
        >
            <Head title={t('Attendance Reports')} />
            ...
            <div className="py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="p-8 bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 shadow-sm rounded-[30px]">
                    ...
                    <div className="flex flex-col justify-between gap-6 mb-8 xl:flex-row xl:items-center">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
                                    {t('Track student attendance records')}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col w-full gap-4 sm:flex-row xl:w-auto">
                            <button
                                ...
                                className="inline-flex justify-center items-center px-6 py-3.5 bg-cyan-50 text-[#0e7490] hover:bg-cyan-100 border border-cyan-100 rounded-[35px] font-bold shadow-sm transition-all"
                            >
                    ...
                    {/* Filter Section (Styled like Search) */}
                    <div className="bg-gray-50 dark:bg-gray-700/30 p-6 rounded-[25px] border border-gray-100 dark:border-gray-700 mb-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div className="lg:col-span-1">
                                <div className="relative">
                                    <input
                                        type="text"
                                        className="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 shadow-sm bg-white dark:bg-gray-800 rounded-[20px] pl-10 focus:ring-2 focus:ring-[#0e7490] focus:border-transparent dark:text-white transition-all"
                                        value={filters.student_national_id}
                                        onChange={e => setFilters(prev => ({ ...prev, student_national_id: e.target.value }))}
                            ...
                            <div>
                                <select
                                    className="w-full px-4 py-3 border border-gray-200 dark:border-gray-600 shadow-sm bg-white dark:bg-gray-800 rounded-[20px] focus:ring-2 focus:ring-[#0e7490] focus:border-transparent dark:text-white transition-all cursor-pointer"
                            ...
                            <div className="grid grid-cols-2 gap-2 lg:col-span-2">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    <button
                                        onClick={fetchData}
                                        className="px-4 py-2 bg-[#0e7490] text-white rounded-[20px] hover:bg-[#155e75] transition-all shadow-md"
                                        title={t('Search')}
                                    >
                                        🔍
                                    </button>
                ...
                {/* --- STATS CARDS --- */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-[25px] border border-blue-100 dark:border-blue-800">
                            <div className="flex items-center gap-4">
                                <span className="text-4xl">📊</span>
                                <div>
                                    <p className="text-sm font-bold text-blue-600 dark:text-blue-400 uppercase">{t('Total Records')}</p>
                                    <p className="text-3xl font-bold text-gray-800 dark:text-white">{stats.total}</p>
                                </div>
                            </div>
                        </div>
                        <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-[25px] border border-green-100 dark:border-green-800">
                            <div className="flex items-center gap-4">
                                <span className="text-4xl">✅</span>
                                <div>
                                    <p className="text-sm font-bold text-green-600 dark:text-green-400 uppercase">{t('Present')}</p>
                                    <p className="text-3xl font-bold text-gray-800 dark:text-white">{stats.present}</p>
                        ...
                        <div className="bg-red-50 dark:bg-red-900/20 p-6 rounded-[25px] border border-red-100 dark:border-red-800">
                            <div className="flex items-center gap-4">
                                <span className="text-4xl">❌</span>
                                <div>
                                    <p className="text-sm font-bold text-red-600 dark:text-red-400 uppercase">{t('Absent')}</p>
                                    <p className="text-3xl font-bold text-gray-800 dark:text-white">{stats.absent}</p>
                ...
                {/* --- RESULTS TABLE --- */}
                    ...
                    {loading ? (
                        <div className="p-10 text-center text-gray-500 dark:text-gray-400">
                                <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-[#0e7490]"></div>
                                ...
                                <table className="min-w-full text-start">
                                    <thead className="bg-gray-50 dark:bg-gray-700/50 border-b-2 border-gray-200 dark:border-gray-600">
                                        <tr>
                                            ...
                                            <th className="px-6 py-4 text-xs font-bold text-[#0e7490] dark:text-cyan-400 uppercase text-start">{t('Class')}</th>
                                            <th className="px-6 py-4 text-xs font-bold text-[#0e7490] dark:text-cyan-400 uppercase text-start">{t('Supervisor')}</th>
                                    ...
                                    <tbody className="divide-y divide-gray-100 dark:divide-gray-700 bg-white dark:bg-gray-800">
                                        {attendance.map((a) => (
                                            <tr key={a.id} className="hover:bg-cyan-50 dark:hover:bg-cyan-900/10 transition-colors">
                                                <td className="px-6 py-4 font-bold text-gray-700 dark:text-gray-300 transform font-mono text-sm">
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        <div className="flex flex-col">
                                                            <span className="font-bold text-gray-800 dark:text-white">
                                                                {a.student?.full_name || a.student?.name || t('Unknown')}
                                                            </span>
                                                ...
                                                <td className="px-6 py-4 text-center">
                                                    {a.status === 'present' ? (
                                                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-green-50 text-green-700 border border-green-200 dark:bg-green-900/30 dark:text-green-400 dark:border-green-800">
                                                            ✅ {t('Present')}
                                                        </span>
                                                    ) : (
                                                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-red-50 text-red-700 border border-red-200 dark:bg-red-900/30 dark:text-red-400 dark:border-red-800">
                                                            ❌ {t('Absent')}
                                                </span>
                                                    )}
                                                </td>
                                                <td className="px-6 py-4 text-end">
                                                    <div className="flex items-center justify-end gap-2">
                                                        <button
                                                            ...
                                                            className="p-2 text-[#0e7490] hover:bg-cyan-50 dark:hover:bg-cyan-900/20 rounded-[10px] transition-all"
                                                            title={t('Edit')}
                                                        >
                                                            ✎
                                                        </button>
                                                        <button
                                                            ...
                                                            className="p-2 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-[10px] transition-all"
                                                            title={t('Delete')}
                                                        >
                                                            🗑️
                                                        </button>
                                    ...
                                    <div className="p-16 text-center">
                                        ...
                                        <p className="text-gray-400 dark:text-gray-500 font-medium">{t('No attendance data found')}</p>
                        </div>
                    )}
                </div>
            </div>
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => setShowModal(false)}>
                    <div
                        className="bg-white dark:bg-gray-800 rounded-[30px] shadow-2xl max-w-lg w-full overflow-hidden transform transition-all animate-in fade-in zoom-in-95 duration-200"
                        onClick={(e) => e.stopPropagation()}
                    >
                        <div className="bg-[#0e7490] p-6 text-white flex justify-between items-center">
                            <div>
                                <h2 className="text-xl font-bold">
                                    {editingRecord ? t('Edit Attendance') : t('New Attendance Record')}
                                </h2>
                                <p className="text-white/80 text-sm mt-1">
                                    {t('Please details below')}
                                </p>
                            </div>
                            <button
                        ...
                        <form onSubmit={handleSubmit} className="p-8 space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <InputLabel value={t('Class')} className="dark:text-gray-300 font-bold mb-2" />
                                    <select
                                        value={formData.classroom_id}
                                        onChange={e => setFormData({ ...formData, classroom_id: e.target.value })}
                                        className="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-[20px] focus:ring-[#0e7490] focus:border-transparent p-3.5 transition-shadow"
                                        required
                                ...
                                <div>
                                    <InputLabel value={t('Student')} className="dark:text-gray-300 font-bold mb-2" />
                                    <select
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <InputLabel value={t('Date')} className="dark:text-gray-300 font-bold mb-2" />
                                    <input
                                        type="date"
                                        value={formData.date}
                                ...
                                <div>
                                    <InputLabel value={t('Status')} className="dark:text-gray-300 font-bold mb-2" />
                                    <div className="flex justify-center mt-1">
                                        <button
                                            ...
                                            className={`relative inline-flex h-12 w-48 items-center rounded-full transition-all focus:outline-none focus:ring-4 focus:ring-offset-2
                                                ...
                                                ? 'bg-[#0e7490] focus:ring-[#0e7490] shadow-xl shadow-cyan-500/30'
                            ...
                            <div className="flex justify-between items-center pt-6 mt-6 border-t border-gray-100 dark:border-gray-700">
                                <SecondaryButton
                                    onClick={() => setShowModal(false)}
                                    className="px-6 py-3 rounded-[15px] border-0 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold"
                                    disabled={processing}
                                >
                                    {t('Cancel')}
                                </SecondaryButton>
                                <button
                                    type="submit"
                                    disabled={processing}
                                    className="inline-flex items-center justify-center text-white bg-[#0e7490] hover:bg-[#155e75] rounded-[15px] px-10 py-3 shadow-lg hover:shadow-xl transition-all font-bold disabled:opacity-50 disabled:cursor-not-allowed"
                                >
            ...
            {showBulkModal && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => setShowBulkModal(false)}>
                    <div
                        className="bg-white dark:bg-gray-800 rounded-[30px] shadow-2xl max-w-xl w-full overflow-hidden transform transition-all animate-in fade-in zoom-in-95 duration-200"
                        onClick={(e) => e.stopPropagation()}
                    >
                        <div className="bg-[#0e7490] p-6 text-white flex justify-between items-center">
                            <div>
                        ...
                        <form onSubmit={handleBulkSubmit} className="p-8 space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <InputLabel value={t('Select Class')} className="dark:text-gray-300 font-bold mb-2" />
                                    <select
                                ...
                                <>
                                    <div className="flex gap-2 justify-center pb-2">
                                        <button
                                            ...
                                            className="px-4 py-2 bg-cyan-100 text-[#0e7490] rounded-lg text-xs font-bold hover:bg-cyan-200 transition"
                                        >
                                            ✓ {t('All Present')}
                                        </button>
                                        <button
            ...
            {confirmingDeletion && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => setConfirmingDeletion(false)}>
                    <div
                        className="bg-white dark:bg-gray-800 rounded-[30px] shadow-2xl max-w-sm w-full overflow-hidden transform transition-all animate-in fade-in zoom-in-95 duration-200"
                        onClick={(e) => e.stopPropagation()}
                    >
                        <div className="p-8 text-center">
                            ...
                            <div className="flex justify-center gap-3">
                                <button
                                    ...
                                    className="px-6 py-2.5 rounded-[15px] border-0 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold transition-colors"
                                >
                                    {t('Cancel')}
                                </button>
                                <button
                                    ...
                                    disabled={processing}
                                    className="px-6 py-2.5 rounded-[15px] bg-red-600 hover:bg-red-700 text-white font-bold shadow-lg hover:shadow-red-500/30 transition-all"
                                >
                                    {t('Delete')}
                                </button>
                            </div>
