    ...
    useEffect(() => {
        if (data.template_id) {
            const template = templates.find(
                (t) => t.id === parseInt(data.template_id),
            );
            if (template) {
                setData({
                    ...data,
    ...
    const handlePreview = async () => {
        try {
            const response = await axios.post(
                route("school.notifications.preview"),
                data,
            );
        ...
        >
            ...
            <div className="max-w-2xl mx-auto space-y-6">
                <form
                    ...
                    className="bg-white dark:bg-gray-800 rounded-[30px] shadow-sm border border-gray-100 dark:border-gray-700 p-8 space-y-6"
                >
                    {/* Template Selector */}
                    <div className="bg-cyan-50 dark:bg-cyan-900/20 p-6 rounded-[25px] border border-cyan-200 dark:border-cyan-800">
                        ...
                        >
                            <option value="">
                                {t("Select a template or create custom")}
                            </option>
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700/30 p-6 rounded-[30px] border border-gray-100 dark:border-gray-700">
                        ...
                        <div className="space-y-3">
                            <label
                                className={`flex items-center gap-4 p-4 border rounded-[20px] cursor-pointer transition-all ${
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500">
                                        {t(
                                            "Send to all guardians in the school",
                                        )}
                                    </p>
                                </div>
                            </label>
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-gray-500">
                                        {t(
                                            "Send to parents of specific classrooms",
                                        )}
                                    </p>
                                </div>
                            </label>
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-gray-500">
                                        {t(
                                            "Send to parents of students on specific buses",
                                        )}
                                    </p>
                                </div>
                            </label>
                            ...
                            {data.recipient_type === "specific_parent" && (
                                <div className="ml-9 mt-2">
                                    <select
                                        value={
                                            data.recipient_filter.guardian_id ||
                                            ""
                                        }
                                        onChange={(e) =>
                                            setData("recipient_filter", {
