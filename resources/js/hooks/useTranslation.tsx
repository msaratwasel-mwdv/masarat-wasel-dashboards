...
const dictionary = {
    ...
    'Enter new guardian details': { ar: 'أدخل بيانات ولي الأمر الجديد', en: 'Enter new guardian details' },
    'Please create a new guardian': { ar: 'يرجى إنشاء ولي أمر جديد', en: 'Please create a new guardian' },
    'up to 5MB': { ar: 'حتى 5 ميجابايت', en: 'up to 5MB' },
    'Enter student details': { ar: 'أدخل بيانات الطالب', en: 'Enter student details' },
    'Are you sure you want to delete this student?': { ar: 'هل أنت متأكد من حذف هذا الطالب؟', en: 'Are you sure you want to delete this student?' },
    'No students found': { ar: 'لم يتم العثور على طلاب', en: 'No students found' },
    'Search': { ar: 'بحث', en: 'Search' },
    ...
    'Attendance Overview': { ar: 'نظرة عامة على الحضور', en: 'Attendance Overview' },
    'Track student attendance records': { ar: 'متابعة سجلات حضور الطلاب', en: 'Track student attendance records' },
    'Search ID...': { ar: 'بحث بالهوية...', en: 'Search ID...' },
    'Please details below': { ar: 'يرجى إدخال التفاصيل أدناه', en: 'Please enter details below' },
    ...
    'Search buses by number or plate...': { ar: 'بحث برقم الحافلة أو اللوحة...', en: 'Search buses by number or plate...' },
    ...
    'Google Maps Not Loaded': { ar: 'لم يتم تحميل خرائط جوجل', en: 'Google Maps Not Loaded' },
    'Please check your Google Maps API key...': { ar: 'يرجى التحقق من مفتاح API...', en: 'Please check your Google Maps API key...' },
    'Exit': { ar: 'خروج', en: 'Exit' },
    'Fullscreen': { ar: 'ملء الشاشة', en: 'Fullscreen' },
    'No buses with location data': { ar: 'لا توجد حافلات ببيانات الموقع', en: 'No buses with location data' },
    'Try adjusting your filters': { ar: 'جرب تعديل المرشحات', en: 'Try adjusting your filters' },
    'Waiting for GPS data from buses...': { ar: 'بانتظار بيانات GPS من الحافلات...', en: 'Waiting for GPS data from buses...' },
    'On Route': { ar: 'في الطريق', en: 'On Route' },
    'At School': { ar: 'في المدرسة', en: 'At School' },
    'Bus Request History': { ar: 'سجل طلبات الحافلات', en: 'Bus Request History' },
    'Manage your transportation requests': { ar: 'إدارة طلبات النقل الخاصة بك', en: 'Manage your transportation requests' },
    ...
    'No requests match your search': { ar: 'لا توجد طلبات تطابق بحثك', en: 'No requests match your search' },
    'Click New Request to submit one': { ar: 'اضغط على طلب جديد لتقديم طلب', en: 'Click New Request to submit one' },
    'Delete Selected': { ar: 'حذف المحدد', en: 'Delete Selected' },
    'Are you sure you want to delete this bus?': { ar: 'هل أنت متأكد من حذف هذه الحافلة؟', en: 'Are you sure you want to delete this bus?' },
    'Are you sure you want to delete the selected buses?': { ar: 'هل أنت متأكد من حذف الحافلات المحددة؟', en: 'Are you sure you want to delete the selected buses?' },
    'Fill in the bus details below': { ar: 'املأ تفاصيل الحافلة أدناه', en: 'Fill in the bus details below' },
    ...
    'Explain why you need this bus request...': { ar: 'اشرح سبب حاجتك لهذا الطلب...', en: 'Explain why you need this bus request...' },
    ...
    'Copy Weekly Schedules': { ar: 'نسخ الجداول الأسبوعية', en: 'Copy Weekly Schedules' },
    'Copy schedules from one week to another': { ar: 'نسخ الجداول من أسبوع لآخر', en: 'Copy schedules from one week to another' },
    'Source Week (Start Date)': { ar: 'الأسبوع المصدر (تاريخ البدء)', en: 'Source Week (Start Date)' },
    'Select the Monday of the source week': { ar: 'اختر يوم الاثنين للأسبوع المصدر', en: 'Select the Monday of the source week' },
    'Target Week (Start Date)': { ar: 'الأسبوع الهدف (تاريخ البدء)', en: 'Target Week (Start Date)' },
    'Select the Monday of the target week': { ar: 'اختر يوم الاثنين للأسبوع الهدف', en: 'Select the Monday of the target week' },
    'Select Buses (Optional)': { ar: 'اختر الحافلات (اختياري)', en: 'Select Buses (Optional)' },
    'Leave empty to copy all buses': { ar: 'اتركه فارغاً لنسخ كل الحافلات', en: 'Leave empty to copy all buses' },
    'Copying...': { ar: 'جاري النسخ...', en: 'Copying...' },
    'This is an exception schedule (holiday, exam day, etc.)': { ar: 'هذا جدول استثنائي (عطلة، يوم امتحان، إلخ)', en: 'This is an exception schedule (holiday, exam day, etc.)' },
    'e.g., Holiday, Exam Day, Special Event': { ar: 'مثال: عطلة، يوم امتحان، حدث خاص', en: 'e.g., Holiday, Exam Day, Special Event' },
    ...
    'Enter teacher name...': { ar: 'أدخل اسم المعلم...', en: 'Enter teacher name...' },
    'teachers added': { ar: 'معلمين مضافين', en: 'teachers added' },
    'drivers selected': { ar: 'سائقين محددين', en: 'drivers selected' },
    'No drivers available': { ar: 'لا يوجد سائقين متاحين', en: 'No drivers available' },
    ...
    'Compose and send notifications to parents': { ar: 'كتابة وإرسال إشعارات لأولياء الأمور', en: 'Compose and send notifications to parents' },
    'Quick Template': { ar: 'قالب سريع', en: 'Quick Template' },
    'Select a template (optional)': { ar: 'اختر قالب (اختياري)', en: 'Select a template (optional)' },
    ...
    'Select Classroom': { ar: 'اختر الفصل', en: 'Select Classroom' },
    'Select Bus': { ar: 'اختر الحافلة', en: 'Select Bus' },
    'Select Parent': { ar: 'اختر ولي الأمر', en: 'Select Parent' },
