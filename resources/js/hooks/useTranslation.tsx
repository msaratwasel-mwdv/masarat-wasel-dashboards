...
"No Trips Found": { ar: "لم يتم العثور على رحلات", en: "No Trips Found" },
  ...
  "Add New Teacher": { ar: "إضافة معلم جديد", en: "Add New Teacher" },
  "Active Teacher Account": { ar: "حساب معلم نشط", en: "Active Teacher Account" },
  "Deactivated Teacher Account": { ar: "حساب معلم معطل", en: "Deactivated Teacher Account" },
  ...
  "Search by Name, ID...": { ar: "ابحث بالاسم، الرقم...", en: "Search by Name, ID..." },
  "Demographics": { ar: "توزيع الطلاب", en: "Demographics" },
  "Transport Utilization": { ar: "استخدام الحافلات", en: "Transport Utilization" },
  "using buses": { ar: "يستخدمون الحافلات", en: "using buses" },
  ...
  "Student Binding Rate": { ar: "معدل الارتباط بالطلاب", en: "Student Binding Rate" },
  "linked to students": { ar: "مرتبطون بطلاب", en: "linked to students" },
  ...
  "Preferred Language": { ar: "اللغة المفضلة", en: "Preferred Language" },
  "Guardian Image": { ar: "صورة ولي الأمر", en: "Guardian Image" },
  ...
  // Trips Dashboard
   ...
   "تم استيراد مدراء المدارس بنجاح وتحديث القائمة.": { ar: "تم استيراد مدراء المدارس بنجاح وتحديث القائمة", en: "School managers imported successfully" },
    ...
    // Admin Dashboard - Flash Notifications & System Messages
    "تم تحديث بيانات المدرسة والاشتراك بنجاح": { ar: "تم تحديث بيانات المدرسة والاشتراك بنجاح", en: "School and subscription updated successfully." },
    "تم تسجيل المدرسة بنجاح وإعداد اشتراكها": { ar: "تم تسجيل المدرسة بنجاح وإعداد اشتراكها", en: "School registered and subscription set up successfully." },
    "تم حذف المدرسة بنجاح": { ar: "تم حذف المدرسة بنجاح", en: "School deleted successfully." },
    "تم رفض الطلب": { ar: "تم رفض الطلب", en: "Request rejected successfully." },
    "تم الموافقة على الطلب وتعيين الحافلة بنجاح": { ar: "تم الموافقة على الطلب وتعيين الحافلة بنجاح", en: "Request approved and bus assigned successfully." },
    "تم حذف العطلة بنجاح": { ar: "تم حذف العطلة بنجاح", en: "Holiday deleted successfully." },
    "تم تحديث العطلة بنجاح وإرسال الإشعارات": { ar: "تم تحديث العطلة بنجاح وإرسال الإشعارات", en: "Holiday updated and notifications sent successfully." },
    "تم إنشاء العطلة بنجاح وإرسال الإشعارات": { ar: "تم إنشاء العطلة بنجاح وإرسال الإشعارات", en: "Holiday created and notifications sent successfully." },
    "تمت إضافة البند بنجاح": { ar: "تمت إضافة البند بنجاح", en: "Inspection item added successfully." },
    "تم التعديل بنجاح": { ar: "تم التعديل بنجاح", en: "Item updated successfully." },
    "تم الحذف بنجاح": { ar: "تم الحذف بنجاح", en: "Item deleted successfully." },
    "تم إضافة الخطة بنجاح": { ar: "تم إضافة الخطة بنجاح", en: "Plan added successfully." },
    "تم تحديث الخطة بنجاح": { ar: "تم تحديث الخطة بنجاح", en: "Plan updated successfully." },
    "تم حذف الخطة بنجاح": { ar: "تم حذف الخطة بنجاح", en: "Plan deleted successfully." },
    "تم تغيير حالة الخطة بنجاح": { ar: "تم تغيير حالة الخطة بنجاح", en: "Plan status changed successfully." },
    "تم حذف المصروف بنجاح": { ar: "تم حذف المصروف بنجاح", en: "Expense deleted successfully." },
    "تمت إضافة المصروف بنجاح": { ar: "تمت إضافة المصروف بنجاح", en: "Expense added successfully." },
    "تم تعديل المصروف بنجاح": { ar: "تم تعديل المصروف بنجاح", en: "Expense updated successfully." },
    "تم إلغاء الرحلة بنجاح.": { ar: "تم إلغاء الرحلة بنجاح.", en: "Field trip cancelled successfully." },
    "تم الموافقة على الرحلة بنجاح.": { ar: "تم الموافقة على الرحلة بنجاح.", en: "Field trip approved successfully." },
    "تم الموافقة على الرحلة وتحديد التكلفة والحافلة بنجاح.": { ar: "تم الموافقة على الرحلة وتحديد التكلفة والحافلة بنجاح.", en: "Field trip approved and bus assigned successfully." },
    "تم تحديث التقويم بنجاح": { ar: "تم تحديث التقويم بنجاح", en: "Academic calendar updated successfully." },
    "تم إنشاء التقويم الدراسي بنجاح": { ar: "تم إنشاء التقويم الدراسي بنجاح", en: "Academic calendar created successfully." },
    "تم حذف التقويم بنجاح": { ar: "تم حذف التقويم بنجاح", en: "Academic calendar deleted successfully." },
    "تم حذف البلاغ بنجاح": { ar: "تم حذف البلاغ بنجاح", en: "Emergency report deleted successfully." },
    "تم تحديث حالة البلاغ بنجاح": { ar: "تم تحديث حالة البلاغ بنجاح", en: "Emergency report status updated successfully." },
    "تم حذف تقرير المخالفة بنجاح": { ar: "تم حذف تقرير المخالفة بنجاح", en: "Violation report deleted successfully." },
    "تم إضافة الفعالية بنجاح": { ar: "تم إضافة الفعالية بنجاح", en: "Event added successfully." },
    "تم تحديث الفعالية بنجاح": { ar: "تم تحديث الفعالية بنجاح", en: "Event updated successfully." },
    "تم حذف الفعالية بنجاح": { ar: "تم حذف الفعالية بنجاح", en: "Event deleted successfully." },
    "تم تفعيل الاشتراك بنجاح": { ar: "تم تفعيل الاشتراك بنجاح", en: "Subscription activated successfully." },
    "تم تحديث الاشتراك بنجاح": { ar: "تم تحديث الاشتراك بنجاح", en: "Subscription updated successfully." },
    "تم رفض الاشتراك بنجاح": { ar: "تم رفض الاشتراك بنجاح", en: "Subscription rejected successfully." },
    "تم تسجيل الدفعة بنجاح": { ar: "تم تسجيل الدفعة بنجاح", en: "Payment recorded successfully." },
    "تم تحديث الرحلة بنجاح": { ar: "تم تحديث الرحلة بنجاح", en: "Daily trip updated successfully." },
    "تمت إضافة الرحلة بنجاح": { ar: "تمت إضافة الرحلة بنجاح", en: "Daily trip added successfully." },
    "تم حذف الرحلة بنجاح": { ar: "تم حذف الرحلة بنجاح", en: "Daily trip deleted successfully." },
    "تم تأكيد بدء الرحلة بنجاح": { ar: "تم تأكيد بدء الرحلة بنجاح", en: "Trip start confirmed successfully." },
