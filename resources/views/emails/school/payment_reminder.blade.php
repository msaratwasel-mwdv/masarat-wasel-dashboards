    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                ...
                <div style="background-color: {{ $isOverdue ? '#fef2f2' : '#f0f9ff' }}; border-right: 4px solid {{ $isOverdue ? '#ef4444' : '#3b82f6' }}; padding: 15px; border-radius: 4px;">
                    <p style="margin: 0; font-size: 15px; color: {{ $isOverdue ? '#991b1b' : '#1e3a8a' }};">
                        @if($isOverdue)
