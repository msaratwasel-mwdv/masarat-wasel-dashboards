...
try {
    ...
    $service->sendToUser(
        $parent->id,
        'bus_boarding_afternoon', // نوع الإشعار: صعود باص العودة
        'طالبك ركب باص العودة (تجربة)',
        'لقد ركب الطالب الحافلة للعودة إلى المنزل. (رسالة اختبار)',
        [
            'student_id' => 999, 
            'bus_id' => 999, 
    ...
    echo "✅ Afternoon Boarding Notification (SCRUM-87) sent successfully to '" . $parent->name . "' (National ID: " . $parent->national_id . ")!\n";
    echo "🔔 Check your Flutter app NOW!\n";
    echo "👀 You should see the blue 'Check-In' icon instead of the orange 'Check-Out' icon.\n";
} catch (\Exception $e) {
