...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Add the new check constraint including 'waiting'
        DB::statement("ALTER TABLE trip_attendances ADD CONSTRAINT trip_attendances_status_check CHECK (status::text = ANY (ARRAY['pending'::character varying, 'boarded'::character varying, 'dropped'::character varying, 'absent'::character varying, 'excused'::character varying, 'waiting'::character varying]::text[]))");
    }
