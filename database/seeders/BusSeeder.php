...
class BusSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // Create 5 Buses with tracking data
        $buses = [
            [
                'bus_number' => 'BUS-001',
                'bus_code' => 'BUS-001',
                ...
                'status' => 'active',
                'color' => 'أبيض',
                'current_latitude' => 21.5433,
                'current_longitude' => 39.1728,
            ...
            [
                ...
                'status' => 'active',
                'color' => 'أزرق',
                'current_latitude' => 21.5500,
                'current_longitude' => 39.1800,
                'last_location_update' => now(),
                'trip_status' => 'at_school',
            ],
            [
                'bus_number' => 'BUS-003',
                'bus_code' => 'BUS-003',
            ...
            [
                ...
                'status' => 'active',
                'color' => 'أخضر',
                'current_latitude' => 21.5400,
                'current_longitude' => 39.1650,
